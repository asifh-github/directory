...
function list(){
    ...
    var ele = <HTMLInputElement>document.getElementById("listAdd");
...
function addToList(){
    ...
    document.getElementById("addNew")!.addEventListener('click', function(){
        var n = (<HTMLInputElement>document.getElementById("putName"))!.value;
        var t = parseInt((<HTMLInputElement>document.getElementById("putType")).value);
        var h = parseInt((<HTMLInputElement>document.getElementById("putHeight")).value);
        var w = parseInt((<HTMLInputElement>document.getElementById("putWeight")).value);
        var a = parseInt((<HTMLInputElement>document.getElementById("putAbility")).value);
...
function moreInfo(){    
    ...
    var n = <HTMLInputElement>document.getElementById("getName");
    var t = <HTMLInputElement>document.getElementById("getType");
    var h = <HTMLInputElement>document.getElementById("getHeight");
    var w = <HTMLInputElement>document.getElementById("getWeight");
    var a1 = <HTMLInputElement>document.getElementById("getAliblityType");
    var a2 = <HTMLInputElement>document.getElementById("getAbility");
    var o = <HTMLInputElement>document.getElementById("getOverall");
