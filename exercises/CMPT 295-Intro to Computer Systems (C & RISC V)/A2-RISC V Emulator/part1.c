...
void print_lui(Instruction instruction) {
    ...
    printf(LUI_FORMAT, instruction.utype.rd, (instruction.utype.imm << 12));
...
void print_store(char *name, Instruction instruction) {
    ...
    unsigned int imm = get_store_offset(instruction);
...
void print_branch(char *name, Instruction instruction) {
    ...
    unsigned int imm = get_branch_offset(instruction);
