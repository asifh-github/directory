...
tests_json = """{
  "arraylist": {
      "timeout 60 ./Arraylist/arraylist.bin --verbose": 10
      },
  "strcmp": {
      "timeout 60 ./word-count/test_strcmp.bin --verbose": 10
      }
    }
"""
...
difftests_json = """{
    "tokenize": {
    "timeout 60 ./word-count/tokenize.bin ./word-count/txt/input.txt > ./word-count/out/input.txt.tokenize; diff  ./word-count/out/input.txt.tokenize ./word-count/reference/input.txt.tokenize": 20
    },
    "dictionary": {
    "timeout 60 ./word-count/dictionary.bin ./word-count/txt/input.txt > ./word-count/out/input.txt.dictionary; diff  ./word-count/out/input.txt.dictionary ./word-count/reference/input.txt.dictionary": 20
    },
    "linecount": {
    "timeout 60 ./word-count/linecount.bin ./word-count/txt/input.txt > ./word-count/out/input.txt.linecount; diff  ./word-count/out/input.txt.linecount ./word-count/reference/input.txt.linecount": 20
    }
}"""
...
#        p = subprocess.Popen("egrep \"strcmp|strlen|isalnum|strdup|strcat|strncpy|strncmp\" word-count/*.c",
 #                            shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
        p = subprocess.Popen("egrep -n \"strcmp|strlen|isalnum|strdup|strcat|strncpy|strncmp|strtok\" word-count/vector_string.c word-count/dictionary.c word-count/tokenize.c word-count/linecount.c",
                             shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
        p.wait()
        return_grep = 0
