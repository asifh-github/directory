...
def main():
    ...
    # (2) create a naïve bayes classifier with different color values and train it, use pipeline
    ...
    # (4) create a k-nearest neighbours classifier with different color values and train it, use pipeline
    ...
    rf_rgb_model = RandomForestClassifier(n_estimators=100, max_depth=10)

    # (6) create a random forest classifier with different color values and train it, use pipeline
